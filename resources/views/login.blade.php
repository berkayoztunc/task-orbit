    ...
    <section id="login" class="min-h-screen flex items-center justify-center p-6 relative z-10">
        <div class="w-full max-w-md glass rounded-[2.5rem] shadow-2xl overflow-hidden">
            <div class="p-10 space-y-8">
                ...
                <div class="space-y-6">
                    <a href="#" class="w-full h-16 rounded-2xl bg-blue-600 text-white flex items-center justify-center gap-3 font-bold text-sm shadow-xl shadow-blue-600/20 hover:bg-blue-500 transition-all active:scale-[0.98]">
                ...
                <div class="text-center border-t border-slate-800/40 pt-6">
                    <p class="text-sm text-slate-400 font-medium">
                        Hesabınız yok mu? <a href="#register" class="text-blue-500 hover:underline font-bold">Kayıt Olun</a>
                    </p>
                </div>
            </div>
